...
<!-- main begin-->
 <div class="main">
   <div class="sidebar">
     <p><img src="${ctx}/images/paimai.jpg" width="443" height="314" alt="" /></p>
   </div>
   <div class="sidebarg">
     <form action="login" method="post" >
    <div class="login">
      <dl>
        <dt class="blues">用户登陆  <span style="color: red">${msg}</span></dt>
        <dd><label for="name">用户名：</label><input type="text" class="inputh" value="" id="name" name="username"/></dd>
        <dd><label for="password" type=password>密 码：</label><input type="text" class="inputh" value="" id="password" name="userpassword"/></dd>
        <dd>
